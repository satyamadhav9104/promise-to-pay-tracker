...
from sqlalchemy import Column, String, Float, DateTime, Enum as SAEnum, Integer, Index
...
class Invoice(Base):
    ...
    created_date = Column(DateTime, default=get_utc_now, nullable=False, index=True)
    status = Column(SAEnum(InvoiceStatus), default=InvoiceStatus.CREATED, nullable=False, index=True)
